...
class DB():
    ...
    connection_removers = {"postgresql": postgresql.close_connection}
    ...
    def connect(self):
        try:
            ...
            logging.error(
                f'[G-utils]--- DB - {self.db} - Failed to connect with error:{e}'
            )
    ...
    def close_connection(self):
        connection_remover = self.connection_removers[self.db]
        connection_remover(self.connection)